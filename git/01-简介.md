...
<img src="../_images/git/Xnip2024-11-07_09-03-12.jpg" style="zoom: 55%;" />
...
<img src="../_images/git/local.png" style="zoom:40%;" />
...
<img src="../_images/git/centralized.png" style="zoom:55%;" />
...
<img src="../_images/git/distributed.png" style="zoom:40%;" />
...
<img src="../_images/git/Cohen-Linus-Torvalds.jpg" style="zoom:35%;" />

### 差异比较

传统的版本控制系统（例如 SVN）是基于差异的版本控制，它们存储的是一组基本文件和每个文件随时间逐步累积的差异。

<img src="../_images/git/deltas.png" style="zoom: 40%;" />
...
<img src="../_images/git/snapshots.png" style="zoom:40%;" />
...
<img src="../_images/git/areas.png" style="zoom: 50%;" />
